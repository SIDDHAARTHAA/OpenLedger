  ...
  components: {
    ...
    schemas: {
      User: {
        ...
        required: ["id", "role", "status", "createdAt", "updatedAt"],
      },
      FinancialRecord: {
        type: "object",
        properties: {
        ...
        required: ["id", "amount", "type", "category", "entryDate", "createdAt", "updatedAt"],
      },
    },
  },
  paths: {
    ...
    "/records": {
      get: {
        ...
        responses: {
          "200": { description: "Records loaded" },
          ...
          content: {
            "application/json": {
              schema: {
                ...
                required: ["amount", "type", "category", "entryDate"],
              },
            },
          },
        },
    ...
    "/dashboard/summary": {
      get: {
        tags: ["Dashboard"],
        summary: "Dashboard summary totals and recent activity",
        security: [{ sessionCookie: [] }],
        responses: {
    ...
    "/dashboard/trends": {
      get: {
        tags: ["Dashboard"],
        summary: "Dashboard trend buckets",
        security: [{ sessionCookie: [] }],
        parameters: [
          {
            in: "query",
        ...
        responses: {
          "200": { description: "Trend response returned" },
        },
      },
    },
  },
